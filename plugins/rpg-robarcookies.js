...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  conn.reply(m.chat, `*☠️ 𝑯𝒆𝒚! 𝑬𝒔𝒑𝒆𝒓𝒂 ${msToTime(time - new Date())} 𝒑𝒂𝒓𝒂 𝒗𝒐𝒍𝒗𝒆𝒓 𝒂 𝒓𝒐𝒃𝒂𝒓*`, m, rcanal);
  return;
  }
  let who;
...
return;
  ...
  conn.reply(m.chat, `*🏴‍☠️ 𝑹𝒐𝒃𝒂𝒔𝒕𝒆 ${rob} Cookies 🍪 𝒂 @${who.split`@`[0]}*`, m, {mentions: [who]});
