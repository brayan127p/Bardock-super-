...
const texto1 = `*_𔓕꯭  ꯭ ꯭ 𓏲꯭֟፝੭ ꯭⌑𝐁𝐫𝐨𝐨𝐤-𝐁𝐨𝐭-𝐌𝐃⌑꯭ 𓏲꯭֟፝੭ ꯭  ꯭ ꯭𔓕_*
...
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '<(✿◠‿◠)> 𝐁𝐫𝐨𝐨𝐤-𝐁𝐨𝐭-𝐌𝐃', sourceUrl: cn, thumbnail: logo7 }}, quoted: estilo});
try {
await m.react(rwait);
