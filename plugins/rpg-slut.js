...
m.reply(`☠️ Ya Te Has Postituido Recientemente, Espera ⏱️ *${tiempo2}* Para Volver A Las Calles Y Evitar Destruir Tu culo.`)
return
}
...
text: `☠️¡Te Postituiste Y Ganaste *${amountTaken} Cookies 🍪* Dejaste Casi Seco A @${randomUserId.split("@")[0]}\n\nSe suman *+${amountTaken} Cookies 🍪* a ${senderName}.`,
contextInfo: { 
...
conn.sendMessage(m.chat, {
text: `🏴‍☠️ Vuelves A Las Calles Y Te Vas A Un Motel Te Paga ${smallAmountTaken} Cookies 🍪* de @${randomUserId.split("@")[0]}\n\nSe suman *+${smallAmountTaken} Cookies 🍪* a ${senderName}.`,
contextInfo: { 
mentionedJid: [randomUserId],
}}, { quoted: m })
break
