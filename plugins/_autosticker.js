...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return await m.reply('᥀·࣭࣪̇˖🔥◗  *Hola Si El video lo quieres para sticker en movimiento no debe de durar mas de 7 segundos, saludos.*')
