...
conn.reply(m.chat, `❮💰❯ 𝗡𝗼 𝘁𝗶𝗲𝗻𝗲𝘀 𝘀𝘂𝗳𝗶𝗰𝗶𝗲𝗻𝘁𝗲𝘀 𝐑𝐨𝐭𝐨𝗖𝗼𝗶𝗻𝘀 𝗽𝗮𝗿𝗮 𝘂𝘀𝗮𝗿 𝗲𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼.`, m, rcanal)       
continue     
}
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|izar|mente|pero|tion|age|ous|ate|and|but|ify|Kakaroto|or|a|s)/gi)) {
...
const msg = {
rowner: '「👑」 *Esta función solo puede ser usada por mi creador*\n\n> Saiyan*\n\n*¿No apoyas siguiendo el canal?* 😥https://whatsapp.com/channel/0029VakfOZfHFxP7rNrUQk2d.', 
owner: '「👑」 *Esta función solo puede ser usada por mi desarrollador.', 
mods: '「🤴🏻」 *Esta función solo puede ser usada por mis desarrolladores.*\n\n*¿Nos apoyas siguiendo el canal?* 😥https://whatsapp.com/channel/0029VakfOZfHFxP7rNrUQk2d', 
...
private: '「🍭」 *Esta función solo puede ser usada en chat privado.*\n\n*¿unete al grupo? https://whatsapp.com/channel/0029VakfOZfHFxP7rNrUQk2d', 
